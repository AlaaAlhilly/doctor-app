 ...
 <div class='card'>
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label for="phone">Enter the old number first please</label>
            <div class="form-group">
                <input type="text" class="input-medium bfh-phone" name="old_phone" data-format="+1 (ddd) ddd-dddd" required>
            </div>
        </div>
        <hr>
        <div class="form-group">
        ...
        <div class="form-group">
            <input id="update_pat" type="submit" class="btn btn-primary" value="Update"/>
        </div>
        </form>
        </div>
